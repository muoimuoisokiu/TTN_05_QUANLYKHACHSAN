                ...
                if (!string.IsNullOrEmpty(txt_ten.Text))
                {
                    if (!string.IsNullOrEmpty(txt_namsinh.Text))
                    {
                        if (!string.IsNullOrEmpty(txt_socm.Text))
                        {
                            ...
                            {
                                MessageBox.Show("Nh?p S? Ng??i ??t Phòng", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                txt_songuoidp.Focus();
                            }
                        }
                        else
                        {
                            MessageBox.Show("Nh?p S? Ch?ng Minh", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                            txt_socm.Focus();
                        }
                    }
                    else
                    {
                        MessageBox.Show("Nh?p N?m Sinh", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txt_namsinh.Focus();
                    }
                }
                else
                {
                    MessageBox.Show("Nh?p Tên", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txt_ten.Focus();
                }
